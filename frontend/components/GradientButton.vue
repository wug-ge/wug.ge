<template>
  <button
    :class="
      cn(
        'relative flex items-center justify-center min-w-20 min-h-8 overflow-hidden before:absolute before:-inset-[200%] animate-rainbow rainbow-btn',
        props.class,
      )
    "
  >
    <span class="btn-content inline-flex size-full items-center justify-center px-4 py-1">
      <slot />
    </span>
  </button>
</template>
